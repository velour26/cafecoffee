...
MENU = [
    ...
    ("Раф лавандовый", "Кофе", 240, 300,
     ...
     "https://images.unsplash.com/photo-1572286258217-215cf8e8c5fa?w=400"),
    ...
    ("Кофе по-восточному", "Кофе", 180, 80,
     ...
     "https://images.unsplash.com/photo-1565881606991-789c2962a5a3?w=400"),
    ("Айс-латте", "Кофе", 220, 300,
     "Холодный латте со льдом — освежает и бодрит",
     "https://images.unsplash.com/photo-1517959105821-eaf2591984ca?w=400"),
    ("Глясе", "Кофе", 250, 300,
    ...
    ("Эклер ванильный", "Десерты", 180, 80,
     ...
     "https://images.unsplash.com/photo-1607920591413-e2d72ed3fa42?w=400"),
    # Завтраки
    ...
    ("Сэндвич с тунцом", "Завтраки", 290, 200,
     ...
     "https://images.unsplash.com/photo-1559054663-e9d1c4e98a1c?w=400"),
...
async def seed() -> None:
    ...
    async with AsyncSessionLocal() as session:
        if await already_seeded(session):
            print("[seed] cafe уже засеян — пропускаю")
        ...
        for name, cat_name, price, grams, desc, img in MENU:
